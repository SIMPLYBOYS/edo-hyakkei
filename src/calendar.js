...
// 最短的一場：1151 日。**搜尋出來的，不是證出來的**——五種啟發式加三千次隨機走法，
// 最小值都停在 1151（tools/check-pub.mjs 會重跑並斷言，資料一改就會紅）。
//
// 拆開來看，這個數字自己會解釋自己：
//   收景 944 日（118 × 8）——每個玩家都一樣，一景八日是固定的
//   等季節 207 日——最少就是這麼多，歸不了零
//
// 等待歸不了零是算術，不是設計：春有 42 景，而一個春天約 89–92 天、一景八日，
// 一個春天最多塞得下 11–12 景，所以至少要走過四個春天。夏 3 個、秋 3 個、冬 2 個。
// 這個形狀對每個玩家都相同（實測：換各種挑法與跳法，都是春4/夏3/秋3/冬2）——
// 玩家之間真正會差的只有「等了多久」，而那正是結局要給他看的數字。
export const SHORTEST_DAYS = 1151;
